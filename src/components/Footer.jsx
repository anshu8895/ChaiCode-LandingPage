...
const Footer = () => {
  return (
    <footer className="bg-black relative pt-16 pb-12 overflow-hidden">
      {/* Giant background text */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 opacity-5">
        <h1 className="text-[20rem] font-bold text-yellow-400">CHAICODE</h1>
      </div>
      
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 mb-8">
          {/* Brand Column */}
          <div className="md:col-span-4">
            <div className="flex flex-col h-full">
              ...
              <div className="flex space-x-5 mb-auto">
                ...
                <a href="#" aria-label="Discord" className="text-gray-400 hover:text-white transition">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M7.5 9h-7.5v-7.5h7.5v7.5zm9 0h-7.5v-7.5h7.5v7.5zm9 0h-7.5v-7.5h7.5v7.5zm-18 9h-7.5v-7.5h7.5v7.5zm9 0h-7.5v-7.5h7.5v7.5zm9 0h-7.5v-7.5h7.5v7.5z"/>
                  </svg>
                </a>
              </div>
            </div>
          ...
          <div className="md:col-span-2 md:col-start-7">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition">Cohort</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Coding Hero</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">FreeAPI</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Masterji</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition">Pricing Policy</a></li>
